...
export default function CourierVerifications() {
  ...
  const statusFilterOptions = useMemo(
    () => [
      { value: 'pending', label: t('admin.courierVerification.filters.pending') },
      { value: 'approved', label: t('admin.courierVerification.filters.approved') },
      { value: 'rejected', label: t('admin.courierVerification.filters.rejected') },
      { value: 'unverified', label: t('admin.courierVerification.filters.unverified') },
      { value: 'all', label: t('admin.courierVerification.filters.all') }
    ],
    [t]
  )
